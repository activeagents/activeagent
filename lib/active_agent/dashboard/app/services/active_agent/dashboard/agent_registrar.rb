  ...
  module Dashboard
    ...
    class AgentRegistrar
      ...
      def call
        ...
        return if owner.nil? && ActiveAgent::Dashboard.multi_tenant?
      ...
      def owner_for_trace
        resolver = ActiveAgent::Dashboard.trace_owner_resolver
        return resolver.call(@trace) if resolver

        ActiveAgent::Dashboard.multi_tenant? ? @trace.try(:account) : nil
      end
